...
CORE.storage.sync.get(["prompt", "apiKey"], function (items) {
  if (items && items.prompt) {
    ...
    prompt = "Your output should use the following template: - Emoji Bulletpoint. Give me the definition, root origin, synonyms, antonyms, word families, cultural context, and examples. Keep it simply and short. Use the following content: "
  }
...
const parent = chrome.contextMenus.create({
  ...
  title: "Seach This word",
  contexts: ["all"],
});


// Load on clicking the extension icon in contextMenu
CORE.contextMenus.onClicked.addListener(async (...args) => {
