...
async function run() {
  ...
  const existingRoot = document.getElementById("summarize-root");
  ...
  innerContainerHeading.innerHTML = '<p>Searched <a href="https://chat.openai.com/chat" target="_blank" class="sumz-text-sm">by ChatGPT</a></p>';
